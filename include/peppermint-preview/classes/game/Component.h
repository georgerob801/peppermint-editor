...
namespace peppermint {
	namespace game {
		class Component : public Serialisable, public Toggleable, public editor::gui::GUIInfo, public editor::gui::ComponentParameterRegister {
		public:			
			/// <summary>
			...
			/// <summary>
			/// Runs once every frame in the editor.
			/// </summary>
			virtual void editorLoop() {}
		...
		protected:
			...
			editor::gui::GUIInfo::GUIType displayType = editor::gui::GUIInfo::COMPONENT;
		};
	}
}

...
Renderer::Renderer() {
	...
	this->displayTypeName = "renderer";

	this->registerParameter("vertex colour", &this->vertexColour, FLOATV3);

	this->description = "this component is used as a base to make other rendering components and does nothing by itself";
	this->iconIndex = 9;
}

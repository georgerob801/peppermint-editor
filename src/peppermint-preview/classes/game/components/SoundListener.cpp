...
SoundListener::SoundListener() {
	...
	this->displayTypeName = "sound listener";

	auto settings = this->registerParameter("gain", &this->gain, FLOAT, false, true);
	(*settings).setInRange(0.0f, 1.0f);
	this->registerParameter("use doppler", &this->useDoppler, BOOL);

	this->description = "listens for sound within this world";
	this->iconIndex = 3;
}
